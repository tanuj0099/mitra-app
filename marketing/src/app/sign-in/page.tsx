  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-paper">
      ...
      <div className="w-full max-w-md bg-[#EFECE3] border border-line rounded-2xl p-8 md:p-10 shadow-sm">
        ...
        <p className="text-ink/70 mb-8 font-medium">Sign in to manage your Happy Wheels device.</p>
        ...
        <p className="text-center mt-8 text-ink/70 font-medium text-sm">
          Don't have an account? <Link href="/sign-up" className="text-brand hover:text-accent focus-visible:outline-2 focus-visible:outline-brand rounded-sm underline underline-offset-4">Create one here</Link>
        </p>
      </div>
    </main>
  );
